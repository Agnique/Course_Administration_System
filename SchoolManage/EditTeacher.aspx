...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    职工号:
    <asp:TextBox ID="txtTe_ID" runat="server" Width="150px"></asp:TextBox>
    <br />
    <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="Te_ID" DataSourceID="SqlDataSource1" Font-Size="12px" AutoGenerateSelectButton="True" ShowFooter="True">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="职工号" SortExpression="Te_ID">
                <EditItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("Te_ID") %>' Width="50px"></asp:Label>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text='<%# Bind("Te_ID") %>'></asp:Label>
                </ItemTemplate>
                <FooterTemplate>
            ...
            <asp:TemplateField HeaderText="密码" SortExpression="Pwd">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("Pwd") %>' Width="50px"></asp:TextBox>
            ...
            <asp:TemplateField HeaderText="姓名" SortExpression="Name">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("Name") %>' Width="50px"></asp:TextBox>
            ...
            <asp:TemplateField HeaderText="Email" SortExpression="Email">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("Email") %>' Width="100px"></asp:TextBox>
                </EditItemTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="部门" SortExpression="Dpt">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox5" runat="server" Text='<%# Bind("Dpt") %>' Width="60px"></asp:TextBox>
                ...
                <FooterTemplate>
                    <asp:TextBox ID="txtDpt" runat="server" Width="60px"></asp:TextBox>
            ...
            <asp:TemplateField HeaderText="手机号" SortExpression="Phone">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox3" runat="server" Text='<%# Bind("Phone") %>' Width="80px"></asp:TextBox>
                </EditItemTemplate>
                <ItemTemplate>
