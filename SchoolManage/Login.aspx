...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <table width="300" style="border: 1px solid #507CD1; background-color: #DAE3F5;" align="center">
        ...
        <tr style="height: 35px;">
            ...
            <td>
                <asp:TextBox ID="CheckCodeTxt" runat="server" Width="100px"></asp:TextBox></td>
        </tr>
        <tr style="height: 35px;">
            <td></td>
            <td>
        ...
        <tr style="height: 35px; text-align: center;">
            <td style="font-size: 12pt; font-family: 宋体; text-align: center;">
                <asp:Button ID="btnChange" runat="server" Text="修改密码" OnClick="btnChange_Click" CausesValidation="False" />
            </td>
            <td style="font-size: 12pt; font-family: 宋体; text-align: center;">
